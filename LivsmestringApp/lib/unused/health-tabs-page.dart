...
class _CareerTabsPageState extends State<CareerTabsPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    healthData = findAndReplaceAndTranslate(widget.data);
    _tabController = TabController(length: healthData.chapters.length, vsync: this);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView( // Wrap the entire body in SingleChildScrollView
        child: Column(
          children: healthData.chapters.map((chapter) {
            return Column(
